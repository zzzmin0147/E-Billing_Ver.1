               ...
               with font-awesome or any other icon font library -->
                            ...
                            ?>
                                <li class="nav-item  menu-open">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item">
                                            <a href="../../export/table_st/table_st.php" class="nav-link active">
                                                <i class="far  nav-icon"></i>
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="bg-gray-dark color-palette">ตรวจสอบสถานะวางบิล EXPORT</h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                ...
                                <font size="2">
                                    <table id="table_id" class="table table-striped table-hover table-border table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT * FROM dbo.sonicdb where useridSo = '$userId' and seaSo = 'EXPORT'
                                    ORDER BY tmpSo DESC 
                                    ";
                                            ...
                                            */
                                            ?>
                                                <tr>
                                                    <td class="d-inline"><a class="text-decoration-none text-dark " href="*" target="popup" onclick="window.open('../select/select_so_st.php?invSo=<?php echo $result['invSo']; ?>','name','width=1200,height=600')"><?php echo $result["invSo"]; ?><p class="material-symbols-outlined">fact_check</p></a></td>
                                                    <td><?php
                                                    ...
                                                    <td>
                                                        ...
                                                        if ($result["stSO"] == '0')
                                                            ...
                                                            echo "<span class='badge rounded-pill text-dark bg-success'>" . $result["stShow"] . "</badge>" . "</span>";
                                                    ...
                                                    <td><?php echo $result["stAppPayment"]; ?></td>
                                ...
                                <font size="2">
                                    <table id="table_id" class="table table-striped table-hover table-border table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT * FROM dbo.sonicdb where  useridSo = '$vendorim' and seaSo = 'EXPORT'
                                    ORDER BY tmpSo DESC 
                                    ";
                                            $query = $conn->prepare($sql);
                                            $query->execute();
