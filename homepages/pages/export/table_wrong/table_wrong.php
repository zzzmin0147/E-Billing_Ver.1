...
<head>
    ...
    <title>ตรวจสอบข้อมูลผิดพลาด</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
               ...
               with font-awesome or any other icon font library -->
                            ...
                            ?>
                                <li class="nav-item menu-open">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item">
                                            <a href="../../export/table_wrong/table_wrong.php" class="nav-link active">
                                                <i class="far  nav-icon"></i>
                        ...
                        <div class="card card-primary">
                            <div class="col-md-12">
                                ...
                                <table id="table_id" class="table table-striped table-hover table-border table-sm">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = "SELECT * FROM dbo.sonicdb WHERE stSO = 6 and useridSo ='$userId' and seaSo = 'EXPORT'
                                           ORDER BY tmpSo DESC 
                                           ";
                ...
                <div class="content-wrapper">
                    ...
                    <div class="content-header">
                        <div class="container-fluid">
                            <div class="row mb-2">
                                <div class="col-sm-6">
                                    <h1 class="bg-gray-dark color-palette">ตรวจสอบข้อมูลผิดพลาด EXPORT</h1>
                                </div><!-- /.col -->
                                <div class="col-sm-6">
                                    <ol class="breadcrumb float-sm-right">
                            ...
                            <div class="card card-primary">
                                <div class="col-md-12">
                                    ...
                                    <table id="table_id" class="table table-striped table-hover table-border table-sm">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = "SELECT * FROM dbo.sonicdb WHERE stSO = 6 and  useridSo = '$vendorim' and seaSo = 'EXPORT' dePartMent ='$department'
                                        ORDER BY tmpSo DESC 
                                        ";
                                            $query = $conn->prepare($sql);
                                            $query->execute();
                        ...
                        <div class="card card-primary">
                            <div class="col-md-12">
                                ...
                                <table id="table_id" class="table table-striped table-hover table-border table-sm">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = "SELECT * FROM dbo.sonicdb WHERE stSO = 6 and  useridSo = '$vendorim' and seaSo = 'EXPORT'
                                        ORDER BY tmpSo DESC 
                                        ";
                                        $query = $conn->prepare($sql);
                                        $query->execute();
