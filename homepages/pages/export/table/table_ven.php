               ...
               with font-awesome or any other icon font library -->
                            <?php if ((@$_SESSION['userlevel'] == "sonic")
                                ...
                                <li class="nav-item menu-open">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item">
                                            <a href="../../export/table/table_ven.php" class="nav-link active">
                                                <i class="far  nav-icon"></i>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="bg-gray-dark color-palette">ลงข้อมูลวางบิล EXPORT</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="col-md-5">
                            <div class="card card-primary">
                                <form method="post" action="../table/export.php" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="exampleInputFile">File input</label>
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" id="exampleInputFile" name="excel_file" accept=".csv" required="required">
                                                    <label class="custom-file-label" for="exampleInputFile">Excel File</label>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="dePartMent" id="exampleRadios1" value="B" require>
                                                    <label class="form-check-label" for="exampleRadios1">
                                                        BOI
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="dePartMent" id="exampleRadios2" value="S">
                                    ...
                                    <!-- /.card-body -->
                                    <div class="card-footer">
                                        <button type="submit" class="btn btn-sm btn-primary" name="export" value="Submit">Submit</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        <div class="card card-primary">
                            <div class="col-md-12">
                                ...
                                <table id="table_id" class="table table-striped table-hover table-border table-sm">
                                    ...
                                    <?php
                                    $sql = "SELECT * FROM dbo.sonicdb WHERE stSO = 0 and useridSo = '$vendorim' and seaSo = 'EXPORT'
                                    ORDER BY tmpSo DESC 
                                    ";
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($count == 0) { ?>
                                                        <a class="text-decoration-none text-dark " href="*" target="popup" onclick="window.open('../uploadfile/uploadfile.php?invSo=<?php echo $result['invSo']; ?>','name','width=450,height=250')">
                                                            <p class="material-symbols-outlined">upload_file</p>
                                                        </a>
                                                    <?php } ?>
                                                    <?php if ($count == 1) { ?>
                                                        ...
                                                        <a target="_blank" class="material-symbols-outlined text-decoration-none text-primary" href="../file_export/<?php echo $result['FilesName']; ?>"><?php echo "Download"; ?></a>
                                                    <?php } ?>
                                ...
                                <form method="post" action="../table/export.php" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="" required>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="dePartMent" id="exampleRadios1" value="B" >
                                                    <label class="form-check-label" for="exampleRadios1">
                                                        BOI
                                                    </label>
                                                </div>
                        ...
                        <div class="card card-primary">
                            <div class="col-md-12">
                                ...
                                <table id="table_id" class="table table-striped table-hover table-border table-sm">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = "SELECT * FROM dbo.sonicdb WHERE stSO = 0
                                        and useridSo ='$userId' and seaSo = 'EXPORT'
                                        ORDER BY tmpSo DESC 
                                        ";
                                        $query = $conn->prepare($sql);
                                        $query->execute();
