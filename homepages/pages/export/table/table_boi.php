               ...
               with font-awesome or any other icon font library -->
                            ...
                            ?>
                                <li class="nav-item menu-open">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item">
                                            <a href="../../export/table/table_boi.php" class="nav-link active">
                                                <i class="far  nav-icon"></i>
                                                <p><small>EXPORT</small></p>
                                            </a>
                                        </li>
                        ...
                        <div class="col-md-12">
                            ...
                            <table id="table_id" class="table table-striped table-hover table-border table-sm">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT * FROM dbo.sonicdb WHERE stSO = 1 
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="material-symbols-outlined text-decoration-none text-success" href="../app/apr_ok.php?invSo=<?php echo $result['invSo']; ?>&stSO=<?php echo '2' ?>" onclick="return confirm('Do you want to Done this record? !!!')">done</a>
