               ...
               with font-awesome or any other icon font library -->
                            ...
                            ?>
                                <li class="nav-item menu-open">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item">
                                            <a href="../../export/table/table_scm_m.php" class="nav-link active">
                                                <i class="far  nav-icon"></i>
                                                <p><small>EXPORT</small></p>
                                            </a>
                                        </li>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="material-symbols-outlined text-decoration-none text-success" href="../app/apr_ok.php?invSo=<?php echo $result['invSo']; ?>&stSO=<?php echo '3' ?>" onclick="return confirm('Do you want to Done this record? !!!')">done</a>
