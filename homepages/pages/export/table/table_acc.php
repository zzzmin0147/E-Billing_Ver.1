...
<head>
    ...
    <title>ตรวจสอบข้อมูลวางบิล</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
               ...
               with font-awesome or any other icon font library -->
                            ...
                            ?>
                                <li class="nav-item menu-open">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item">
                                            <a href="../../export/table/table_acc.php" class="nav-link active">
                                                <i class="far  nav-icon"></i>
                                                <p><small>EXPORT</small></p>
                                            </a>
                                        </li>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="bg-gray-dark color-palette">ตรวจสอบข้อมูลวางบิล EXPORT</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            ...
                            <table id="table_id" class="table table-striped table-hover table-border table-sm">
                                ...
                                <?php if ($_SESSION['userlevel'] == "acc") { ?>
                                    <tbody>
                                        ...
                                        $sql = "SELECT * FROM dbo.sonicdb WHERE stSO = 4 
                                    and seaSo = 'EXPORT'
                                    ...
                                    ORDER BY tmpSo DESC ";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="material-symbols-outlined text-decoration-none text-success" href="../app/apr_ok.php?invSo=<?php echo $result['invSo']; ?>&stSO=<?php echo '5' ?>" onclick="return confirm('Do you want to Done this record? !!!')">done</a>
                                ...
                                <?php } else { ?>
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = "SELECT * FROM dbo.sonicdb WHERE stSO = 4 and useridSo = '$vendorim' and seaSo = 'EXPORT'
                                    ORDER BY tmpSo DESC ";
                                        $query = $conn->prepare($sql);
                                        $query->execute();
