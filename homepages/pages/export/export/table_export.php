               ...
               with font-awesome or any other icon font library -->
                            ...
                            ?>
                                <li class="nav-item menu-open">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item">
                                            <a href="../../export/export/table_export.php" class="nav-link active">
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="bg-gray-dark color-palette">EXPORT EXCEL IMPORT</h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 btn-group">
                                            ...
                                            <div>
                                                ...
                                                &nbsp;<a class="material-symbols-outlined btn btn-dark mb-3" href="export_ok.php?d_s=<?php echo $d_s; ?>&d_e=<?php echo $d_e; ?>&useridSo=<?php echo $userId; ?>" class="btn">exit_to_app</a>
                                            </div>
                                        </div>
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="bg-gray-dark color-palette">EXPORT EXCEL EXPORT</h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div>
                                            ...
                                            &nbsp;<a class="material-symbols-outlined btn btn-dark mb-3" href="export_ok.php?d_s=<?php echo $d_s; ?>&d_e=<?php echo $d_e; ?>&useridSo=<?php echo $vendorim;  ?>&conSigNee=<?php echo $company;  ?>" class="btn">exit_to_app</a>
                                        </div>
                                    </div>
...
<?php } elseif ((@$_SESSION['userlevel'] == "boi")
            || (@$_SESSION['userlevel'] == "boimng")
            || (@$_SESSION['userlevel'] == "scm")
        ) { ?>
                            ...
                            <div class="row">
                                <div class="col-md-12 btn-group">
                                    ...
                                    <div>
                                        ...
                                        &nbsp;<a class="material-symbols-outlined btn btn-dark mb-3" href="export_ok.php?d_s=<?php echo $d_s; ?>&d_e=<?php echo $d_e; ?>&useridSo=<?php echo $vendorim;  ?>&department=<?php echo $department;  ?>" class="btn">exit_to_app</a>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 btn-group">
                                    ...
                                    <div>
                                        ...
                                        &nbsp;<a class="material-symbols-outlined btn btn-dark mb-3" href="export_ok.php?d_s=<?php echo $d_s; ?>&d_e=<?php echo $d_e; ?>&useridSo=<?php echo $vendorim;  ?>" class="btn">exit_to_app</a>
                                    </div>
                                </div>
