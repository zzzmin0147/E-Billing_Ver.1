               ...
               with font-awesome or any other icon font library -->
                            ...
                            ?>
                                <li class="nav-item menu-open">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item">
                                            <a href="../../import/table/table_acc.php" class="nav-link active"> <!-- ใส่  url-->
                                                <i class="far  nav-icon"></i>
                                                <p><small>IMPORT</small></p>
                                            </a>
                                        </li>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="bg-gray-dark color-palette">ตรวจสอบข้อมูลวางบิล IMPORT</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                        ...
                        <div class="col-md-12">
                            ...
                            <table id="table_id" class="table table-striped table-hover table-border table-sm">
                                ...
                                <?php } else { ?>
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = "SELECT * FROM dbo.sonicdb WHERE stSO = 4 and useridSo = '$vendorim' and seaSo = 'IMPORT'
                                    ORDER BY tmpSo DESC ";
                                        $query = $conn->prepare($sql);
                                        $query->execute();
