                            ...
                            <?php if ((@$_SESSION['userlevel'] == "sonic")
                                ...
                                <li class="nav-item menu-open">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item">
                                            <a href="../../import/table/table_ven.php" class="nav-link active">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="bg-gray-dark color-palette">ลงข้อมูลวางบิล IMPORT</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="col-md-5">
                            <div class="card card-primary">
                                <form method="post" action="../table/import.php" enctype="multipart/form-data">
                                    <div class="card-body">
                        ...
                        <div class="card card-primary">
                            <div class="col-md-12">
                                ...
                                <table id="table_id" class="table table-striped table-hover table-border table-sm">
                                    ...
                                    <?php
                                    $sql = "SELECT * FROM dbo.sonicdb WHERE stSO = 0 and useridSo = '$vendorim' and seaSo = 'IMPORT'
                                    ORDER BY tmpSo DESC 
                                    ";
                                ...
                                <form method="post" action="../table/import.php" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="dePartMent" id="exampleRadios1" value="B" required>
                                                    <label class="form-check-label" for="exampleRadios1">
                                                        BOI
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="dePartMent" id="exampleRadios2" value="S" required>
                                                    <label class="form-check-label" for="exampleRadios2">
                                                        SCM
                                                    </label>
                                                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <font size="2">
                                    <table id="table_id" class="table table-striped table-hover table-border table-sm">
                                        ...
                                        and useridSo ='$userId' and seaSo = 'IMPORT'
                                        ORDER BY tmpSo DESC 
                                        ";
                                            $query = $conn->prepare($sql);
                                            $query->execute();
