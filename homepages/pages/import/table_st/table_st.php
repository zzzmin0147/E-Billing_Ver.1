               ...
               with font-awesome or any other icon font library -->
                            ...
                            ?>
                                <li class="nav-item menu-open">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item">
                                            <a href="../../import/table_st/table_st.php" class="nav-link active">
                                                <!-- ใส่  url-->
                                                <i class="far  nav-icon"></i>
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="bg-gray-dark color-palette">ตรวจสอบสถานะวางบิล IMPORT</h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                ...
                                <font size="2">
                                    <table id="table_id" class="table table-striped table-hover table-border table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT * FROM dbo.sonicdb where useridSo = '$userId' and seaSo = 'IMPORT'
                                    ORDER BY tmpSo DESC 
                                    ";
                                ...
                                <font size=2>
                                    <table id="table_id" class="table table-striped table-hover table-border table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT * FROM dbo.sonicdb where  useridSo = '$vendorim' and seaSo = 'IMPORT'
                                    ORDER BY tmpSo DESC 
                                    ";
                                            $query = $conn->prepare($sql);
                                            $query->execute();
