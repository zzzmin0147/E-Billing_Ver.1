                    ...
                    <div class="card-footer col-sm-12">
                        ...
                        <?php if ($result["stSO"] == '3') { ?>
                            ...
                            <?php if (
                                ...
                                <a class="material-symbols-outlined text-decoration-none text-success" href="../app/apr_ok_c.php?invSo=<?php echo $result['invSo']; ?>&stSO=<?php echo '4' ?>" onclick="return confirm('Do you want to Done this record? !!!')">done</a>
                                <a class="material-symbols-outlined text-decoration-none text-danger" href="*" target="popup" onclick="window.open('../select/select_so_wrong.php?invSo=<?php echo $result['invSo']; ?>','name','width=700,height=600')">close</a>
                        <?php }
                        } ?>
                        ...
                        <?php if ($result["stSO"] == '5') { ?>
                            ...
                            <?php if (
                                ...
                                <a class="material-symbols-outlined text-decoration-none text-success" href="../app/apr_ok_c.php?invSo=<?php echo $result['invSo']; ?>&stSO=<?php echo '7' ?>" onclick="return confirm('Do you want to Done this record? !!!')">done</a>
                                <a class="material-symbols-outlined text-decoration-none text-danger" href="*" target="popup" onclick="window.open('../select/select_so_wrong.php?invSo=<?php echo $result['invSo']; ?>','name','width=700,height=600')">close</a>
                        <?php }
                        } ?>
