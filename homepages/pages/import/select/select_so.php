                ...
                <div class="card card-dark">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <?php if ($count == 1) { ?>
                                <div class="col-sm-3">
                                    <a target="_blank" class="form-control" href="../file_sonic/<?php echo $result['FilesName']; ?>" readonly><?php echo $result['invSo']; ?></a>
                                </div>
                            <?php }
                            if ($count == 0) { ?>
                                <div class="col-sm-3">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" value="<?php echo number_format($result['wt1_s'], 2); ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <div class="card-footer col-sm-12">
                        ...
                        <?php if ($result["stSO"] == '1') { ?>
                            ...
                            <?php if (
                                ...
                                <form action="../app/apr_ok_c.php?invSo=<?php echo $result['invSo']; ?>&stSO=<?php echo '2'; ?>" method="post" class="form-horizontal">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label text-end">DETAILS</label>
                                        <div class="col-sm-3">
                                            <div class="form-group row">
                                                <textarea name="stComment" id="stComment" rows="4" cols="50"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <button type="submit" style="border:none;" class="material-symbols-outlined text-decoration-none text-success" onclick="return confirm('Do you want to Done this record? !!!')">done</button>

                                    <a class="material-symbols-outlined text-decoration-none text-danger" href="*" target="popup" onclick="window.open('../select/select_so_wrong.php?invSo=<?php echo $result['invSo']; ?>','name','width=700,height=600')">close</a>
                                </form>
                        <?php }
                        } ?>

                        <?php if ($result["stSO"] == '2') { ?>
                            ...
                            <?php if (
                                ...
                                <a class="material-symbols-outlined text-decoration-none text-success" href="../app/apr_ok_c.php?invSo=<?php echo $result['invSo']; ?>&stSO=<?php echo '3' ?>" onclick="return confirm('Do you want to Done this record? !!!')">done</a>
                                <a class="material-symbols-outlined text-decoration-none text-danger" href="*" target="popup" onclick="window.open('../select/select_so_wrong.php?invSo=<?php echo $result['invSo']; ?>','name','width=700,height=600')">close</a>
                        <?php }
                        } ?>

                        <?php if ($result["stSO"] == '3') { ?>
                            ...
                            <?php if (
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-6 col-form-label bg-dark text-center">COMMENT MD</label>
                                </div>
                                <form action="../app/apr_ok_c.php?invSo=<?php echo $result['invSo']; ?>&stSO=<?php echo '4'; ?>" method="post" class="form-horizontal">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label text-end">DETAILS</label>
                                        <div class="col-sm-3">
                                            <div class="form-group row">
                                                <textarea name="md_comment" id="md_comment" rows="4" cols="50"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <button type="submit" style="border:none;" class="material-symbols-outlined text-decoration-none text-success" onclick="return confirm('Do you want to Done this record? !!!')">done</button>
                        ...
                        <?php if ($result["stSO"] == '5') { ?>
                            ...
                            <?php if (
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group row">
                                            <textarea  rows="4" cols="50" readonly><?php echo $result['stComment'] ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group row">
                                            <textarea  rows="4" cols="50" readonly><?php echo $result['md_comment'] ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <a class="material-symbols-outlined text-decoration-none text-danger" href="*" target="popup" onclick="window.open('../select/select_so_wrong.php?invSo=<?php echo $result['invSo']; ?>','name','width=700,height=600')">close</a>
                        ...
                        <?php if ($result["stSO"] == '4') { ?>
                            ...
                            <?php if (
                                ...
                                <a class="material-symbols-outlined text-decoration-none text-success" href="../app/apr_ok_c.php?invSo=<?php echo $result['invSo']; ?>&stSO=<?php echo '5' ?>" onclick="return confirm('Do you want to Done this record? !!!')">done</a>
                                <a class="material-symbols-outlined text-decoration-none text-danger" href="*" target="popup" onclick="window.open('../select/select_so_wrong.php?invSo=<?php echo $result['invSo']; ?>','name','width=700,height=600')">close</a>
                        <?php }
                        } else {
                        };
