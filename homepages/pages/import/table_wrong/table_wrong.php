               ...
               with font-awesome or any other icon font library -->
                            ...
                            ?>
                                <li class="nav-item menu-open">
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item">
                                            <a href="../../import/table_wrong/table_wrong.php" class="nav-link active">
                                                <!-- ใส่  url-->
                                                <i class="far  nav-icon"></i>
                        ...
                        <div class="card card-primary">
                            <div class="col-md-12">
                                ...
                                <table id="table_id" class="table table-striped table-hover table-border table-sm">
                                    ...
                                    <tbody>
                                        <?php
                                          $sql = "SELECT * FROM dbo.sonicdb WHERE stSO = 6 and useridSo ='$userId' and seaSo = 'IMPORT'
                                           ORDER BY tmpSo DESC 
                                           ";
                            ...
                            <div class="card card-primary">
                                <div class="col-md-12">
                                    ...
                                    <table id="table_id" class="table table-striped table-hover table-border table-sm">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = "SELECT * FROM dbo.sonicdb WHERE stSO = 6 and  useridSo = '$vendorim' and seaSo = 'IMPORT' dePartMent ='$department'
                                        ORDER BY tmpSo DESC 
                                        ";
                                            $query = $conn->prepare($sql);
                                            $query->execute();
                ...
                <div class="card card-primary">
                    <div class="col-md-12">
                        ...
                        <table id="table_id" class="table table-striped table-hover table-border table-sm">
                            ...
                            <tbody>
                                <?php
                                $sql = "SELECT * FROM dbo.sonicdb WHERE stSO = 6 and  useridSo = '$vendorim' and seaSo = 'IMPORT'
                                        ORDER BY tmpSo DESC 
                                        ";
                                $query = $conn->prepare($sql);
                                $query->execute();
