  ...
  <body>
    ...
    <table align="center" width="100%" border="1" cellspacing="1" cellpadding="1">
      <tr>
        ...
        <td align="center">PORT CHARGE</td>
        <td align="center">CUSTOMS OVER TIME
        </td>
        <td align="center">ADVANCE OTHER DESCRIPTION
        </td>
        ...
        <td align="center">TRANSPORT OVER TIME
          ...
          <!-- NEW LIST  -->
        <td align="center">OCEAN FREIGHT</td>
        <td align="center">AIR FREIGHT</td>
        <td align="center">CARRIER DELIVERY ORDER</td>
        <td align="center">THC PORT OF DISCHARGE</td>
        <td align="center">CONTAINER CLEANING FEE</td>
        <td align="center">EQUIPMENT CONTAINER FEE</td>
        <td align="center">IMPORT HANDLING FEE</td>
        <td align="center">EX-WORK COST</td>
